...
from src.model import HARExperimentResult, HARFeatureConfig, HARRunConfig
        ...
        [
            {
                ...
                "selection_info_json": json_dumps(result.selection_info),
...
def load_result_cache(cache_dir: Path, key: str) -> HARExperimentResult | None:
    paths = cache_paths(cache_dir, key)
