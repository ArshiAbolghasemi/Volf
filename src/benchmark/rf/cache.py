...
from src.model import RFExperimentResult, RFFeatureConfig, RFRunConfig
...
def load_result_cache(cache_dir: Path, key: str) -> RFExperimentResult | None:
    paths = cache_paths(cache_dir, key)
