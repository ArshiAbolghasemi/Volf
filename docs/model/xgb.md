...
- Include climate variables for agricultural commodities (critical for crop volatility)
...
### Window Strategy
- **Expanding**: For stable long-term patterns
- **Rolling**: For adaptive forecasting in changing markets

### Target Mode Selection
- **Point targets**: For specific date forecasting, tactical trading, capturing volatility spikes
- **Mean targets**: For risk management, strategic planning, smoother predictions

### Computational Considerations
- XGBoost is computationally efficient with histogram-based algorithm
